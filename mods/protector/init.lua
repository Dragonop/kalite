...
protector.can_dig = function(r, pos, digger, onlyowner, infolevel)
	...
	if infolevel == 2 then
		...
		if #positions < 1 then
			--if areas:canInteract(pos, digger) then
			local ppl = areas:getNodeOwners(pos)
			if #ppl > 0 then
				minetest.chat_send_player(digger,
				"This area is owned by:")
				for _, names in ipairs(ppl) do
					minetest.chat_send_player(digger, names)
				end
...
minetest.register_node("protector:protect", {
	...
	drawtype = "nodebox",
	tiles = {
		"default_stone.png^protector_logo.png",
		"default_stone.png^protector_logo.png",
		"default_stone.png^protector_logo.png"
	},
	sounds = default.node_sound_stone_defaults(),
	--groups = {dig_immediate = 2, unbreakable = 1},
	groups = {cracky = default.dig.iron_door, unbreakable = 1},
...
minetest.register_craft({
	...
	recipe = {"default:stone", "protector:protect2"}
})
...
minetest.register_node("protector:protect2", {
	...
	sounds = default.node_sound_stone_defaults(),
	groups = {cracky = default.dig.iron_door, unbreakable = 1},
	--groups = {dig_immediate = 1, unbreakable = 1}, --dig_immediate = 2
	paramtype = "light",
