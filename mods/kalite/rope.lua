...
minetest.register_on_punchnode(function(pos, oldnode, digger)
	if oldnode.name == "kalite:rope" then
		rope.remove(pos, oldnode, digger, "kalite:rope")
	end
end)
...
minetest.register_node("kalite:rope", {
	description = "Rope",
	drawtype = "plantlike",
	walkable = false,
	climbable = true,
	...
	tiles = {"kalite_rope.png"},
	inventory_image = "kalite_rope_inv.png",
	wield_image = "kalite_rope_inv.png",
	selection_box = {
		type = "fixed",
