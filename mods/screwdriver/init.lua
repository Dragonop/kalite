...
local function screwdriver_handler(itemstack, user, pointed_thing, mode)
	...
	if name == "screwdriver:screwdriver_bronze" then
		USES = 500
	elseif name == "screwdriver:screwdriver_iron" then
		USES = 250
	end
...
minetest.register_tool("screwdriver:screwdriver_bronze", {
	description = "Bronze Screwdriver",
	inventory_image = "screwdriver_bronze.png",
	on_use = function(itemstack, user, pointed_thing)
		screwdriver_handler(itemstack, user, pointed_thing, screwdriver.ROTATE_FACE)
		return itemstack
	end,
...
minetest.register_tool("screwdriver:screwdriver_iron", {
	description = "Iron Screwdriver",
	inventory_image = "screwdriver.png",
	on_use = function(itemstack, user, pointed_thing)
		screwdriver_handler(itemstack, user, pointed_thing, screwdriver.ROTATE_FACE)
		return itemstack
...
minetest.register_craft({
	output = "screwdriver:screwdriver_bronze",
	recipe = {
...
minetest.register_craft({
	output = "screwdriver:screwdriver_iron",
	recipe = {
		{"default:iron_ingot"},
		{"group:stick"}
	}
...
minetest.register_alias("screwdriver:screwdriver", "screwdriver:screwdriver_iron")
