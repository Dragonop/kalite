...
function doors.register_door(name, def)
	...
	local function on_rightclick(pos, dir, check_name, replace, replace_dir, params)
		...
		if minetest.get_meta(pos):get_int("right") ~= 0 then
			minetest.sound_play(snd_1, {pos = pos, gain = 0.15, max_hear_distance = 10})
		else
			minetest.sound_play(snd_2, {pos = pos, gain = 0.15, max_hear_distance = 10})
		end
	end
...
doors.register_door("doors:door_wood", {
	...
	groups = {choppy = default.dig.wood, door = 1, flammable = 3},
...
doors.register_door("doors:door_steel", {
	...
	groups = {cracky = default.dig.iron_door, door = 1},
...
function doors.register_trapdoor(name, def)
	...
	def.on_rightclick = function (pos, node, clicker, itemstack, pointed_thing)
		...
		if sound then
			minetest.sound_play(sound, {pos = pos, gain = 0.15, max_hear_distance = 10})
		end
...
doors.register_trapdoor("doors:trapdoor", {
	...
	--groups = {snappy = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, door = 1},
	groups = {choppy = default.dig.wood, flammable = 3, door =1},
	sounds = default.node_sound_wood_defaults(),
